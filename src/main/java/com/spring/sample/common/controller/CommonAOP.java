...
public class CommonAOP {
	 ...
	 * && -> 필터 추가
	 */
	@Pointcut("execution(* com.spring.sample..TestController2.b*(..))"
			+ "&&!execution(* com.spring.sample..TestController2.*Log*(..))"
			+ "&&!execution(* com.spring.sample..TestController2.*s(..))"
			+ "&&!execution(* com.spring.sample..TestController2.*Join*(..))"
			+ "&&!execution(* com.spring.sample..TestController2.*Ajax(..))")
	public void testAOP() {}
